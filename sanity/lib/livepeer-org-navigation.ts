...
const query = defineQuery(`{
  ...
  "Blog": *[_id == "livepeerBlogPost-ai-x-open-media-forum" && category == "Community" && heroImage.asset->_createdAt >= $uploadedAfter][0].heroImage.asset->url,
  ...
  "Agent Playbooks": *[_id == "livepeerBlogPost-onchain-builders-streamplace" && heroImage.asset->_createdAt >= $uploadedAfter][0].heroImage.asset->url,
