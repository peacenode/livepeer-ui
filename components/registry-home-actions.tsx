...
export function RegistryHomeActions() {
  ...
  return (
    <div className="grid w-full max-w-3xl gap-3 sm:grid-cols-2 sm:gap-4">
      <Button
        nativeButton={false}
        render={<Link href="/docs" />}
        size="lg"
        className="h-16 w-full rounded-sm border border-emerald-500 bg-emerald-500 px-5 text-base text-white hover:bg-emerald-500 sm:h-20"
        style={{
          backgroundImage:
      ...
      <Button
        ...
        variant="outline"
        size="lg"
        className="h-16 w-full rounded-sm px-5 text-base sm:h-20"
