    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            "z-50 max-h-(--available-height) w-(--anchor-width) min-w-48 overflow-x-hidden overflow-y-auto rounded-3xl bg-popover p-1.5 text-popover-foreground shadow-lg ring-1 ring-foreground/5 outline-none [mask-image:linear-gradient(to_bottom,#000_0%,#000_40%,transparent_60%,transparent_100%)] [mask-position:0_0] [mask-size:100%_250%] transition-[opacity,mask-position] duration-200 ease-out data-starting-style:opacity-0 data-starting-style:[mask-position:0_100%] data-ending-style:opacity-0 data-ending-style:[mask-position:0_100%] dark:ring-foreground/10 motion-reduce:[mask-image:none] motion-reduce:transition-none",
            className
          )}
          {...props}
        />
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        "w-auto min-w-36 rounded-3xl bg-popover p-1.5 text-popover-foreground shadow-lg ring-1 ring-foreground/5 dark:ring-foreground/10",
        className
      )}
      align={align}
      alignOffset={alignOffset}
